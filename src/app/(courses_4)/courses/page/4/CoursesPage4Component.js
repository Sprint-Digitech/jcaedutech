...
export default function CoursesPage4Component() {
  return (
    <ScriptRunner>
...
<li className="llms-loop-item post-6726 course type-course status-publish has-post-thumbnail hentry course_tag-free-analysis course_tag-free-courses course_tag-free-stock-makret-courses course_tag-free-technical-analysis not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_technical-analysis-for-everyone">
	<img src="/wp-content/uploads/2025/05/Technical-Analysis-for-Everyone_2-copy.webp" alt="Technical Analysis for Everyone" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Technical Analysis for Everyone</h4>
...
<li className="llms-loop-item post-6729 course type-course status-publish has-post-thumbnail hentry course_cat-technology course_tag-free-courses course_tag-free-live-teading course_tag-free-technical-analysis not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_technical-analysis-live-trading-internship">
	<img src="/wp-content/uploads/2025/05/Technical-Analysis-Live-Trading-Internship-copy.webp" alt="Technical Analysis Live Trading Internship" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Technical Analysis Live Trading Internship</h4>
...
<li className="llms-loop-item post-6732 course type-course status-publish has-post-thumbnail hentry course_tag-free-courses course_tag-technical-analysis-free not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_technical-analysis-made-easy-online-certification-course">
	<img src="/wp-content/uploads/2025/05/Technical-Analysis-Made-Easy-–-Online-Certification-Course-copy.webp" alt="Technical Analysis Made Easy – Online Certification Course" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Technical Analysis Made Easy – Online Certification Course</h4>
...
<li className="llms-loop-item post-6735 course type-course status-publish has-post-thumbnail hentry not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_technical-analysis-master-course">
	<img src="/wp-content/uploads/2025/05/Technical-Analysis-Master-Course-copy.webp" alt="Technical Analysis Master Course" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Technical Analysis Master Course</h4>
...
<li className="llms-loop-item post-6747 course type-course status-publish has-post-thumbnail hentry course_cat-long-term course_tag-free-1-yera-courses course_tag-free-courses course_tag-free-stock-market course_tag-free-technical-analyst not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_technical-analysis-master-course-1-year">
	<img src="/wp-content/uploads/2025/05/Technical-Analysis-Master-Course-1-Year-copy.webp" alt="Technical Analysis Master Course (1 Year)" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Technical Analysis Master Course (1 Year)</h4>
...
<li className="llms-loop-item post-6744 course type-course status-publish has-post-thumbnail hentry course_tag-free-courses course_tag-free-stock-market course_tag-free-technical-analyisi course_tag-masterclass not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_technical-analysis-masterclass">
	<img src="/wp-content/uploads/2025/05/Technical-Analysis-Masterclass-copy-1.webp" alt="Technical Analysis Masterclass" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Technical Analysis Masterclass</h4>
...
<li className="llms-loop-item post-6741 course type-course status-publish has-post-thumbnail hentry course_cat-technology not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_wealth-creation-using-technical-analysis">
	<img src="/wp-content/uploads/2025/05/Wealth-Creation-Using-Technical-Analysis-copy.webp" alt="Wealth Creation Using Technical Analysis" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Wealth Creation Using Technical Analysis</h4>
...
<li className="llms-loop-item post-6738 course type-course status-publish has-post-thumbnail hentry course_cat-technology not-enrolled is-complete">
	<div className="llms-loop-item-content">

	<a className="llms-loop-link" href="/course_wealth-creation-using-technical-analysis-6-hours">
	<img src="/wp-content/uploads/2025/05/Wealth-Creation-Using-Technical-Analysis-6-Hours-copy.webp" alt="Wealth Creation Using Technical Analysis (6 Hours)" className="llms-featured-image wp-post-image" />
	<h4 className="llms-loop-title">Wealth Creation Using Technical Analysis (6 Hours)</h4>
...
<ul className='page-numbers'>
	<li><a className="prev page-numbers" href="/courses/page/3">« Previous</a></li>
	...
	<li><span aria-label="Page 4" aria-current="page" className="page-numbers current">4</span></li>
</ul>
</nav>
