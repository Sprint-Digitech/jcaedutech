...
<li id="menu-item-27" className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-19 current_page_item menu-item-27"><a href="/contact" aria-current="page">Contact</a></li>
</ul></div>                                </div>                                
                                        </div> 
...
<li className="page_item page-item-19 current_page_item"><a href="/contact" aria-current="page">Contact</a></li>
...
<li className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-19 current_page_item menu-item-27"><a href="/contact" aria-current="page">Contact</a></li>
</ul></div>        </div>
    </nav>
                            </div>            
...
<div className="reactheme-breadcrumbs porfolio-details">
  ...
  <div className="entry-content">
    		<div data-elementor-type="wp-page" data-elementor-id="19" className="elementor elementor-19">
						<section className="elementor-section elementor-top-section elementor-element elementor-element-ed9a495 elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-height-default wpr-particle-no wpr-jarallax-no wpr-parallax-no wpr-sticky-section-no" data-id="ed9a495" data-element_type="section" data-e-type="section">
						<div className="elementor-container elementor-column-gap-default">
					<div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-ed105b9" data-id="ed105b9" data-element_type="column" data-e-type="column" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
			<div className="elementor-widget-wrap elementor-element-populated">
						<div className="elementor-element elementor-element-cf00995 elementor-widget elementor-widget-image" data-id="cf00995" data-element_type="widget" data-e-type="widget" data-widget_type="image.default">
				<div className="elementor-widget-container">
															<img fetchPriority="high" decoding="async" width="601" height="726" src="/wp-content/uploads/2025/05/We-are-Here-to-Help-You-Succeed.-Join-today-1.webp" className="attachment-large size-large wp-image-6813" alt="" srcSet="/wp-content/uploads/2025/05/We-are-Here-to-Help-You-Succeed.-Join-today-1.webp 601w, /wp-content/uploads/2025/05/We-are-Here-to-Help-You-Succeed.-Join-today-1-248x300.webp 248w" sizes="(max-width: 601px) 100vw, 601px" />															</div>
				</div>
					</div>
		</div>
				<div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-61bc5c5" data-id="61bc5c5" data-element_type="column" data-e-type="column">
			<div className="elementor-widget-wrap elementor-element-populated">
						<div className="elementor-element elementor-element-59dfc29 elementor-widget elementor-widget-react-heading" data-id="59dfc29" data-element_type="widget" data-e-type="widget" data-widget_type="react-heading.default">
				<div className="elementor-widget-container">
					        <div className="react-heading default">
        	<div className="title-inner">        		      		
	            <span className="sub-text "> Get in Touch With Us</span><h2 className="title"><span className="watermark"></span>We’re Here to Help You Succeed. Join today!</h2>	        </div>
	                </div>
        				</div>
				</div>
				<div className="elementor-element elementor-element-2743363 elementor-widget elementor-widget-rt-cf7" data-id="2743363" data-element_type="widget" data-e-type="widget" data-widget_type="rt-cf7.default">
				<div className="elementor-widget-container">
					<div className="form_btn_">
<div className="wpcf7 no-js" id="wpcf7-f5230-p19-o1" lang="en-US" dir="ltr" data-wpcf7-id="5230">
...
<fieldset className="hidden-fields-container"><input type="hidden" name="_wpcf7" value="5230" /><input type="hidden" name="_wpcf7_version" value="6.1.5" /><input type="hidden" name="_wpcf7_locale" value="en_US" /><input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f5230-p19-o1" /><input type="hidden" name="_wpcf7_container_post" value="19" /><input type="hidden" name="_wpcf7_posted_data_hash" value="" />
</fieldset>
<div className="row contact-form">

	<div className="col-lg-6 col-md-6">
		<div className="input-box">
			<p><span className="wpcf7-form-control-wrap" data-name="your-name"><input size="40" maxLength="400" className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Full Name" defaultValue="" type="text" name="your-name" /></span>
			</p>
		</div>
	</div>
	<div className="col-lg-6 col-md-6">
		<div className="input-box mail">
			<p><span className="wpcf7-form-control-wrap" data-name="your-email"><input size="40" maxLength="400" className="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email Address" defaultValue="" type="email" name="your-email" /></span>
			</p>
		</div>
	</div>
	<div className="col-lg-6 col-md-6">
		<div className="input-box moblie">
			<p><span className="wpcf7-form-control-wrap" data-name="your-Phone"><input size="40" maxLength="400" className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Phone No" defaultValue="" type="text" name="your-Phone" /></span>
			</p>
		</div>
	</div>
	<div className="col-lg-6 col-md-6">
		<div className="input-box subject">
			<p><span className="wpcf7-form-control-wrap" data-name="your-subject"><input size="40" maxLength="400" className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Subject" defaultValue="" type="text" name="your-subject" /></span>
			</p>
		</div>
	</div>
	<div className="col-12">
		<div className="input-box text-area">
			<p><span className="wpcf7-form-control-wrap" data-name="your-message"><textarea cols="40" rows="10" maxLength="2000" className="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Message" name="your-message"></textarea></span>
			</p>
		</div>
	</div>
	<div className="col-12">
		<p><input className="wpcf7-form-control wpcf7-submit has-spinner" type="submit" value={isSubmitting ? "Submitting..." : "Submit"} disabled={isSubmitting} style={isSubmitting ? {opacity: 0.7, cursor: 'not-allowed'} : {}} />
		</p>
	</div>
  {submitStatus === 'success' && (
    <div className="col-12" style={{ marginTop: '20px', padding: '15px', backgroundColor: '#dcfce7', color: '#166534', borderRadius: '4px', border: '1px solid #bbf7d0' }}>
      Thank you for contacting us! We will get back to you shortly.
    </div>
  )}
  {submitStatus === 'error' && (
    <div className="col-12" style={{ marginTop: '20px', padding: '15px', backgroundColor: '#fee2e2', color: '#991b1b', borderRadius: '4px', border: '1px solid #fecaca' }}>
      There was an error submitting your message. Please try again.
				...
				<section className="elementor-section elementor-top-section elementor-element elementor-element-0984f36 elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-height-default wpr-particle-no wpr-jarallax-no wpr-parallax-no wpr-sticky-section-no" data-id="0984f36" data-element_type="section" data-e-type="section">
						<div className="elementor-container elementor-column-gap-default">
					<div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-55ef40b" data-id="55ef40b" data-element_type="column" data-e-type="column">
			<div className="elementor-widget-wrap elementor-element-populated">
						<div className="elementor-element elementor-element-ffbc817 elementor-widget elementor-widget-react-heading" data-id="ffbc817" data-element_type="widget" data-e-type="widget" data-widget_type="react-heading.default">
				<div className="elementor-widget-container">
					        <div className="react-heading default">
        	<div className="title-inner">        		      		
	            <span className="sub-text ">Catch Us Here</span><h2 className="title"><span className="watermark"></span> Visit or Connect <br />With Us Directly</h2>	        </div>
	                </div>
        				</div>
				</div>
				<section className="elementor-section elementor-inner-section elementor-element elementor-element-98efb21 elementor-section-boxed elementor-section-height-default elementor-section-height-default wpr-particle-no wpr-jarallax-no wpr-parallax-no wpr-sticky-section-no" data-id="98efb21" data-element_type="section" data-e-type="section">
						<div className="elementor-container elementor-column-gap-extended">
					<div className="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-b13430f" data-id="b13430f" data-element_type="column" data-e-type="column">
			<div className="elementor-widget-wrap elementor-element-populated">
						<div className="elementor-element elementor-element-e46e277 elementor-widget elementor-widget-rt-service-grid" data-id="e46e277" data-element_type="widget" data-e-type="widget" data-widget_type="rt-service-grid.default">
				<div className="elementor-widget-container">
    ...
    <div className="services-part">
	    ...
	    <div className="services-text style5">
	    		    		...
	    		    		<p className="services-txt">  info@jcaedutech.com</p>	
				...
				<div className="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-dc9cd5e" data-id="dc9cd5e" data-element_type="column" data-e-type="column">
			<div className="elementor-widget-wrap elementor-element-populated">
						<div className="elementor-element elementor-element-ca24bab elementor-widget elementor-widget-rt-service-grid" data-id="ca24bab" data-element_type="widget" data-e-type="widget" data-widget_type="rt-service-grid.default">
				<div className="elementor-widget-container">
					<div className="react-addon-services services-style1">
    <div className="services-part">
	    ...
	    <div className="services-text style5">
	    		    		...
	    		    		<p className="services-txt">  New Delhi</p>	
				...
				<section className="elementor-section elementor-top-section elementor-element elementor-element-a8dc22f elementor-section-full_width elementor-section-stretched elementor-section-height-default elementor-section-height-default wpr-particle-no wpr-jarallax-no wpr-parallax-no wpr-sticky-section-no" data-id="a8dc22f" data-element_type="section" data-e-type="section" data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;}">
						<div className="elementor-container elementor-column-gap-default">
					<div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-9318637" data-id="9318637" data-element_type="column" data-e-type="column">
			<div className="elementor-widget-wrap elementor-element-populated">
						<div className="elementor-element elementor-element-3688909 elementor-widget elementor-widget-google_maps" data-id="3688909" data-element_type="widget" data-e-type="widget" data-widget_type="google_maps.default">
				<div className="elementor-widget-container">
							<div className="elementor-custom-embed">
			<iframe loading="lazy"
					src="https://maps.google.com/maps?q=New%20Delhi&#038;t=m&#038;z=14&#038;output=embed&#038;iwloc=near"
					title="New Delhi"
...
<li id="menu-item-6463" className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-19 current_page_item menu-item-6463"><a href="/contact" aria-current="page">Contact</a></li>
</ul></div></section>                    </div>
...
<script type="text/javascript" id="wpr-addons-js-js-extra" dangerouslySetInnerHTML={{__html: "\n/* <![CDATA[ */\nvar WprConfig = {\"ajaxurl\":\"/wp-admin/admin-ajax.php\",\"resturl\":\"/wp-json/wpraddons/v1\",\"nonce\":\"770bfa327a\",\"addedToCartText\":\"was added to cart\",\"viewCart\":\"View Cart\",\"comparePageID\":\"\",\"comparePageURL\":\"contact.htm\",\"wishlistPageID\":\"\",\"wishlistPageURL\":\"contact.htm\",\"chooseQuantityText\":\"Please select the required number of items.\",\"site_key\":\"\",\"is_admin\":\"\",\"input_empty\":\"Please fill out this field\",\"select_empty\":\"Nothing selected\",\"file_empty\":\"Please upload a file\",\"recaptcha_error\":\"Recaptcha Error\",\"woo_shop_ppp\":\"9\",\"woo_shop_cat_ppp\":\"9\",\"woo_shop_tag_ppp\":\"9\",\"is_product_category\":\"\",\"is_product_tag\":\"\"};\n//# sourceURL=wpr-addons-js-js-extra\n/* ]]> */\n" }} />
